...
@interface SubArtiListCell2()
@property (weak, nonatomic) IBOutlet UIImageView *topImageView;

@property (weak, nonatomic) IBOutlet UIView *contentView1;
//@property (weak, nonatomic) IBOutlet UIImageView *artiImgeView;
...
@end
@implementation SubArtiListCell2
- (void)layoutSubviews
{
...
-(void)setItem:(CollectionCellItem *)item{
    _item = item;
    //self.artiImageView.backgroundColor = [UIColor colorWithHexString:item.block_color];
